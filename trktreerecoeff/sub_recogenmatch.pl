...
$workarea = "$BASE/sl6ana/CMSSW_5_3_20/src/UserCode/OpenHF/trktreerecoeff";
...
for ($ifile = 0; $ifile < $njobs ; $ifile ++) {
    ...
    $job_execfile = "runrecoeff\_$istart\_$iend\_$type";

    #-- produce condor configuration file ...
    $config_file = "runrecoeff\_$istart\_$iend\_$type.job";
    &produce_config_file;
...
sub produce_config_file {
    ...
    print OUTPUTFILE ("executable           = run_trktreerecoeff.sh\n");
