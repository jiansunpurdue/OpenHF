...
$workarea = "$BASE/CMSSW_4_4_4/src/UserCode/OpenHF/rereco_speactra";
...
for ($ifile = 0; $ifile < $njobs ; $ifile ++) {
    ...
    $job_execfile = "fillhisto\_$istart\_$iend\_$type";

    #-- produce condor configuration file ...
    $config_file = "fillhisto\_$istart\_$iend\_$type.job";
    &produce_config_file;
...
sub produce_config_file {
    ...
    print OUTPUTFILE ("executable           = run_Fillinghisto.sh\n");
