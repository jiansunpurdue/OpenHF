...
//.. ------------------------- For Ds->Phi+pi ------------------------------
//     root> .x draw_hist.C+ ("ana_candAnaDs2PhiPi_ana_ds2PhiPi.lis_0To11.root", false, "ana_ds2Phi.gif", 10, 1.8, 2.1);
//     fg0: pol2 can not describe background 
//     initial value for all histograms: 
//     1.0 1.97 0.01 400 1.86 0.005
...
//.. ------------------------- For D0->kaon+pi ------------------------------
//     initial value for all histograms: 
//     root>  .x draw_hist.C+ ("ana_D0_tot.root", false, "ana_d0.gif", 10, 1.78, 1.95);
//      1.0 1.87 0.02 0 0 0
//     constraints for all histograms: 
//      1.84 1.9 0 0.05 0 0 0 0 0 0
//.. ------------------------- For Dpm->kaon+pi+pi ------------------------------
//     initial value for all histograms: 
//     root>  .x draw_hist.C+ ("ana_Dpm_tot.root", false, "ana_dpm.gif", 10, 1.78, 2.0);
//      1.0 1.87 0.005 0 0 0
//     constraints for all histograms: 
...
//				if( fittingtry == 1) hfg[i]->Fit(fit_fun, "L", "", rlow, rhigh);
