...
void HFTree::FillCandMCInfo(hfcand* hfcandidate, const edm::Event& iEvent, const edm::EventSetup& iSetup) 
{
    ...
    for(int i = 0; i<hfcandidate->get_nhfcand(); i++) {
        ...
        if(cand->get_gIndex_dau2().size()==0){
            ...
            //    if(tempD2.at(imatch) != -999){
            //        cout << "Found candidate match to main part: "<< index_dau2 << " = " << tempD2.at(imatch) << endl;
            //        cout << "gIndex current size: "<< cand->get_gIndex_dau2().size() << endl;
            //    }
            //}
        ...
        if(cand->get_gIndex1().size()==0){
            ...
            //    if(tempI1.at(imatch) != -999){
            //        cout << "Found candidate match to Index1 part: "<< index1 << " = " << tempI1.at(imatch) << endl;
            //        cout << "gIndex1 current size: "<< cand->get_gIndex1().size() << endl;
            //    }
            //}
        ...
        if(cand->get_gIndex2().size()==0){
            ...
            //    if(tempI2.at(imatch) != -999){
            //        cout << "Found candidate match to Index2 part: "<< index2 << " = " << tempI2.at(imatch) << endl;
            //        cout << "gIndex2 current size: "<< cand->get_gIndex2().size() << endl;
            //    }
            //}
