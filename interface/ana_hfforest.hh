...
class ana_hfforest : public TNamed 
{
    ...
    public:
        ...
        void drawOneTrg(int mesonID, int whichTrg, int Nrebin, bool chk, int it, TCanvas* cc);
        void drawHighMult(int mesonID, int whichTrg, int Nrebin, TFile* fin, TCanvas* cc);
